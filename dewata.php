...
<head>
    ...
    <title>Desa Budaya Dewata</title>
...
<header class="header">
  <div class="container">
    ...
    <div class="containerr">
        <div class="headline">
            <h1>Desa Budaya Dewata</h1>
            <img src="destination2.jpg" alt="Desa Budaya Dewata">
        </div>
        <div class="content">
            <p><strong>Punya rencana ke Bali, tapi belum yakin destinasi mana saja yang mau kamu datangi? Ikut tur ini, Yuk! Tanpa repot, kamu akan diantar menjelajahi cantiknya Pulau Dewata.</strong></p>
            
            <h2>Lokasi</h2>
            <p>Desa Budaya Dewata terletak di Bali, yang menawarkan pengalaman budaya yang kaya dan pemandangan alam yang memukau. Nikmati suasana tradisional Bali, dengan berbagai kegiatan seni, tari, dan kerajinan tangan yang dapat Anda nikmati.</p>
            
            <h2>Highlight Acara</h2>
            <ul>
                <li>Tur budaya Bali, mencakup seni tari dan kerajinan tangan.</li>
                <li>Wisata alam dengan pemandangan sawah terasering dan pegunungan Bali.</li>
                <li>Pengalaman makan malam khas Bali dengan pemandangan sunset.</li>
            </ul>
